                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">{{ __('messages.welcome_back')}}</h1>
                                    </div>
                                    ...
                                    <form  action="{{ route('user.login') }}" method="post">
                                        ...
                                        <div class="form-group">
                                            <label for="role">{{ __('messages.otp_method')}}</label>
                                            <!-- SMS, Email options in select -->
                                            <select name="otp_method" id="role" class="form-control">
                                                <option value="email">{{ __('messages.otp_to_email')}}</option>
                                                <option value="sms">{{ __('messages.otp_to_sms')}}</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <div class="custom-control custom-checkbox small">
                                                <input type="checkbox" class="custom-control-input" id="customCheck">
                                                <label class="custom-control-label" for="customCheck">{{ __('messages.remember_me')}}</label>
                                            </div>
                                        </div>
