                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            <button class="btn btn-primary">Create Student <i class="bi bi-check"></i></button>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control  @error('professional_email') is-invalid @enderror" name="professional_email" >
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control  @error('professional_phone') is-invalid @enderror" name="professional_phone" >
                                ...
                                <div class="form-row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control  @error('speciality_area') is-invalid @enderror" name="speciality_area" id="speciality_area" required>
                                                ...
                                                @foreach($specialityAreas as $specialityArea)
                                                    <option value="{{ $specialityArea->title }}">{{ $specialityArea->title }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="registration_date" title="We get the Promotion Year from here.">
                                            @error('department')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <button type="button" class="btn btn-success mt-3" id="add-field-button">Add Field</button>
