...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div>
            ...
            @if($jobs_in_queue && $jobs_in_queue > 0)
                <a href="{{ route('admin.runQueue') }}" target="_blank" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm">
                    <i class="fas fa-paper-plane fa-sm text-white-50"></i>
                    Re-Send Pending Emails ({{ $jobs_in_queue }})
                </a>
            @endif
