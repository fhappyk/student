...
class UsersDataTable extends DataTable
{
                ...
                return '
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="statusDropdown' . $data->id . '">
                            ...
                            <li><a class="dropdown-item change-status" href="' . route("admin.change.status", [$data->id, 'inactive']) . '" data-id="' . $data->id . '" data-status="inactive">Inactive</a></li>
                            <li><a class="dropdown-item change-status" href="' . route("admin.change.status", [$data->id, 'pending']) . '" data-id="' . $data->id . '" data-status="pending">Pending</a></li>
                        </ul>
                    </div>
                ';
            })
    ...
    {
         $query = $model->newQuery()->where('role', 'student');
    ...
    public function html(): HtmlBuilder
    {
        return $this->builder()
                    ...
                    ->buttons(
                        ...
                        Button::make('csv')->text('<i class="bi bi-file-earmark-spreadsheet-fill"></i> CSV'),
