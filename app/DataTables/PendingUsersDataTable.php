...
class PendingUsersDataTable extends DataTable
{
    ...
    {
         $query = $model->newQuery()->where('role', 'student')->where('status', 'pending');
    ...
    {
        return $this->builder()
                    ->setTableId('pending-listing-table')
    ...
    {
        return 'PendingUsers_'.date('YmdHis');
    }
}
